...
WhereDataHelper.prototype.requestAirportStatus = function(airportCode){
...
WhereDataHelper.prototype.getAirportStatus = function(airportCode) {
	var options = {
		method: 'GET',
...
WhereDataHelper.prototype.formatAirportStatus = function(airportStatus){
	var weather = _.template('The current weather conditions are ${weather}, ${temp} and ${wind}.')({
	...
	if (airportStatus.delay === 'true'){
		var template = _.template('There is currently a delay for ${airport}. ' + 
			...
			'Delay is because of the following: ${delay_time}. ${weather}');
